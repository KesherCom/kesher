...
export function UpdateVariableDefinitions(self: ModuleInstance): void {
  const defs: CompanionVariableDefinition[] = [
    ...
    {
      variableId: "listen_rooms",
      name: "Selected listen room IDs (comma-separated)",
    },
    {
      variableId: "talk_rooms",
      name: "Selected talk room IDs (comma-separated)",
    },
    {
      variableId: "reply_direct_user_id",
      name: "Reply-to-caller direct user ID",
    },
    ...
    { variableId: "signal_message", name: "Signal message (while visible)" },
    {
      ...
      name: "Last command successful (true/false)",
    },
