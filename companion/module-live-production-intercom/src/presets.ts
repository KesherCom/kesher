  ...
  const presets: CompanionPresetDefinitions = {
    always_on: {
      ...
      steps: [
        {
          down: [
            { actionId: "set_voice_mode", options: { mode: "always_on" } },
          ],
          up: [],
        },
      ],
      feedbacks: [
        { feedbackId: "voice_mode_is", options: { mode: "always_on" } },
      ],
    },
    ptt_mode: {
      type: "button",
      ...
      steps: [
        {
          down: [{ actionId: "set_voice_mode", options: { mode: "ptt" } }],
          up: [],
        },
      ],
      ...
      steps: [
        {
          down: [
            {
              actionId: "set_ptt_active_room",
              options: { state: "ptt_start" },
            },
          ],
          up: [
            { actionId: "set_ptt_active_room", options: { state: "ptt_stop" } },
          ],
        },
      ],
          ...
          down: [
            {
              ...
              options: {
                scope: "direct",
                directTargetId: firstDirectUser,
                state: "ptt_start",
              },
            },
          ],
      ...
      steps: [
        {
          down: [
            {
              actionId: "reply_to_caller_ptt",
              options: { state: "ptt_start" },
            },
          ],
          up: [
            { actionId: "reply_to_caller_ptt", options: { state: "ptt_stop" } },
          ],
        },
      ],
      feedbacks: [
          ...
          down: [
            {
              ...
              options: {
                scope: "broadcast",
                broadcastTargetId: firstBroadcast,
                state: "ptt_start",
              },
            },
          ],
